...
//
// structsd v0.21.0 adds canDefend. It is chain-owned and must be persisted
// so upgrade-block struct-type repairs are reflected in PostgreSQL.
//
...
type StructType struct {
	...
	CanDefend                      JSONBool `json:"canDefend"`
